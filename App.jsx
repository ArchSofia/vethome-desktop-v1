...
const testimonialCard222Data = {
	animasLandingPag:
		"“Quiero agradecer a todo el equipo. Tuve que castrar a mi gato Limón y salió de la cirugía sin ningún dolor. Hicimos un control semanas después y no pudo haber salido mejor”",
...
const landingPageV1MobileData = {
	...
	estamosAlServicio:
		"Estamos al servicio con todo el equipo médico y personal especializado para lo que necesites.",
	unidadDeCuidadosIntensivos: "Unidad de cuidados intensivos",
	imagenPorRayosXP:
		"Imagen por rayos X para diagnóstico de patologías y lesiones.",
	losMejoresMdicos:
		"Los mejores médicos veterinarios de todas las especializaciones.",
	somosUnEquipoDeP:
		"Somos un equipo de profesionales especializados graduados de las mejores universidades veterinarias del país. Nuestro staff experimentado trabaja para brindarle a tu mascota la mejor atención.",
	label: "Contactanos",
	veterinarianPhoto: "/img/veterinarian-photo-1@2x.png",
	comunicateConNosotros: "Comunicate con nosotros",
	tenesAlgunaDudaS:
		"¿Tenes alguna duda sobre nuestros servicios? Nuestro equipo está disponible para ayudarte.",
...
const cardInfo22Data = {
	ecografa: "Ecografía",
	diagnsticoDeImge:
		"Diagnóstico de imágenes para visualizar los órganos y tejidos",
	iconProps: icon8Data,
};
...
const macBookAir1Data = {
	...
	screen_Shot_20230722_At_17321:
		"/img/screen-shot-2023-07-22-at-17-32-1@2x.png",
